...
public class Assignment8Tests {
    ...
    public void getTotalPrices(){
        ...
        if(price != 12){
            throw new IncorrectBehaviorException("order.getServicesTotalPrice should've returned 12, but returned " + price);
        }
    }
    ...
    public void testGetItems(){
        ...
        //Services only
        Service s22 = new Service(2,1,22,"srvc2");
        Service s4 = new Service(4,1,4,"srvc4");
        order = new Order();
        order.addToOrder(s22,2);
        order.addToOrder(s4,2);
        ...
        if(!itemList.contains(s4) || !itemList.contains(s22)){
        ...
        itemList = Arrays.asList(items);
        if(!itemList.contains(s4) || !itemList.contains(s22) || !itemList.contains(p1) || !itemList.contains(p2)){
    ...
    public void successfulValidateServices(){
        ...
        OrderManagementSystem system = new OrderManagementSystem(this.products,5,this.providers);
        Order order = new Order();
        Service srvc1 = this.idToService.get(11);
        Service srvc2 = this.idToService.get(22);
    ...
    public void unsuccessfulValidateServicesNotEnoughProviders(){
        ...
        Service srvc1 = this.idToService.get(11);
        Service srvc2 = this.idToService.get(22);
        Service srvc6 = this.idToService.get(66);
    ...
    private void createDemoServiceProviders(){
        Service s1 = new Service(1,1,11,"srvc1");
        Service s2 = new Service(2,1,22,"srvc2");
        Service s3 = new Service(3,1,33,"srvc3");
        Service s4 = new Service(4,1,44,"srvc4");
        Service s5 = new Service(5,1,55,"srvc5");
        Service s6 = new Service(6,1,66,"srvc6");
