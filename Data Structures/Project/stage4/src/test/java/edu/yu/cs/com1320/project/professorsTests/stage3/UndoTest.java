package edu.yu.cs.com1320.project.professorsTests.stage3;
...
public class UndoTest {
    ...
    private DocumentStoreImpl createStoreAndPutOne() throws IOException {
        ...
        dsi.putDocument(bas1,this.uri1, DocumentFormat.TXT);
        return dsi;
    }
    ...
    private DocumentStoreImpl createStoreAndPutAll() throws IOException {
        ...
        dsi.putDocument(bas,this.uri1, DocumentFormat.TXT);
        //doc2
        bas = new ByteArrayInputStream(this.txt2.getBytes());
        dsi.putDocument(bas,this.uri2, DocumentFormat.TXT);
        //doc3
        bas = new ByteArrayInputStream(this.txt3.getBytes());
        dsi.putDocument(bas,this.uri3, DocumentFormat.TXT);
        //doc4
        bas = new ByteArrayInputStream(this.txt4.getBytes());
        dsi.putDocument(bas,this.uri4, DocumentFormat.TXT);
        return dsi;
    }
    ...
    public void undoOverwriteByURI() throws Exception {
        ...
        dsi.putDocument(new ByteArrayInputStream(replacement.getBytes()),this.uri2, DocumentFormat.TXT);
